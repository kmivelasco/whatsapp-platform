...
router.put('/:id', authorize('ADMIN'), (req, res, next) => botConfigController.update(req as any, res, next));
router.delete('/:id', authorize('ADMIN'), (req, res, next) => botConfigController.delete(req as any, res, next));
